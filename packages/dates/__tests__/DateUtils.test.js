...
const constants = dateUtils?.dependencies?.constants || require( "@toolbocks/core/src/Constants.cjs" );
const typeUtils = dateUtils?.dependencies?.typeUtils || require( "@toolbocks/core/src/TypeUtils.cjs" );
const stringUtils = dateUtils?.dependencies?.stringUtils || require( "@toolbocks/core/src/StringUtils.cjs" );
const arrayUtils = dateUtils?.dependencies?.arrayUtils || require( "@toolbocks/core/src/ArrayUtils.cjs" );
const objectUtils = dateUtils?.dependencies?.objectUtils || require( "@toolbocks/common/src/ObjectUtils.cjs" );
